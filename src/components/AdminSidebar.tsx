...
export default function AdminSidebar() {
  ...
  const menuItems: MenuItem[] = [
    ...
    { id: 'services', label: 'Services', icon: Code, href: '/admin/dashboard/services' },
    { id: 'portfolio', label: 'Portfolio', icon: FolderKanban, href: '/admin/dashboard/portfolio' },
    { id: 'quotes', label: 'Quotes', icon: MessageSquareQuote, href: '/admin/dashboard/quotes' },
    { id: 'contacts', label: 'Contacts', icon: Users, href: '/admin/dashboard/contacts' },
    { id: 'consultations', label: 'Consultations', icon: Briefcase, href: '/admin/dashboard/consultations'},
  ];
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-5 left-4 z-[60] bg-gradient-to-r from-orange-600 to-orange-800 text-white p-2.5 rounded-lg shadow-2xl hover:scale-110 transition-transform duration-300"
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-72 bg-white shadow-2xl transform transition-transform duration-300 z-50 border-r-4 border-orange-600 ${
